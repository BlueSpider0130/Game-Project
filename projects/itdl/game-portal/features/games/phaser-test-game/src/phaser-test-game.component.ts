...
@Component({
    selector: 'gpll-phaser-test-game',
    templateUrl: './phaser-test-game.component.html',
    styleUrls: ['./phaser-test-game.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class GpllPhaserTestGameComponent implements OnInit, OnDestroy {
...
class MainScene extends Phaser.Scene {
    ...
    private keys!: any;
    private isKnockedDown = false; //is our player knocked down?
    private isAttacking = false; //is our player attacking?
    private lastDirection = 'down'; //what was the last direction our player was facing?
    ...
    public create() {
        ...
        if (!this.input || !this.input.keyboard) throw new Error('Input not initialized');
